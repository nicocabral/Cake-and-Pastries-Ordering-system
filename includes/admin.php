...
<head>
    ...
    <title>ADMIN | CAKE AND PASTRIES</title>
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="fdid" value="<?php echo $row['id']?>">
        ...
        <dl class="dl-horizontal wow fadeInDown" style="text-align:left">
            ...
            <dt>Qty:</dt> <dd><?php echo $row['oqty'];?></dd>
            <dt>Total:</dt> <dd><?php echo 'P '.number_format($total,2,'.',',');?></dd>
            <hr style="border-top: 1px dashed #8c8b8b;
	border-bottom: 1px dashed #fff;">
    		<dt><em>Customer Details</em></dt><dd></dd>
