    ...
    <div class="col-lg-10">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="savechanges"><i class="glyphicon glyphicon-thumbs-up"></i> Order</button>
                    ...
                    <?php }}else {echo '<strong style="color:red">No availables data in server</strong>';}?>
                </table>
...
if(isset($_POST['savechanges'])){
		...
		$query =mysql_query("SELECT * FROM tblorders WHERE cname = '$name'") or die (mysql_error());
			if(mysql_num_rows($query)==5){
				...
				$sql = mysql_query("INSERT INTO tblorders VALUES(NULL,'$name','$address','$contact','$id','$qty','new',NULL,'$otype','$datep')") or die (mysql_error());
							if($sql==true){
